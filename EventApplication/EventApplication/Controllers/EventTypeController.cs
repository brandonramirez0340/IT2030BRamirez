...
namespace EventApplication.Controllers
{
    ...
    public class EventTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventTypeId,Title")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventTypeId,Title")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
